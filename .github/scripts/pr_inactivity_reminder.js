...
Reach out on the DBpedia forum or join our community meetings if you need assistance.\n\n- ${discordLink}\n- ${office_hours_calendar} \n\nFrom the DBpedia Wikimedia Dumps Team`;
  if (dryRun) {
...
module.exports = async ({github, context}) => {
  ...
  const discordLink = `[DBpedia Forum](https://forum.dbpedia.org)`;
  const office_hours_calendar =`[Community Meetings](https://forum.dbpedia.org)`; 
